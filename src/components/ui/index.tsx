...
const colorMenus = [
  {
    ...
    startColor: '#FFDEE2',
    endColor: '#E37684',
    color: BABYLON.Color3.FromHexString('#E37684'),
  },
  {
    type: 'color2',
    startColor: '#C4E7F5',
    endColor: '#47A9D1',
    color: BABYLON.Color3.FromHexString('#47A9D1'),
  },
  {
    type: 'color3',
    startColor: '#F8F4BE',
    endColor: '#E1D100',
    color: BABYLON.Color3.FromHexString('#E1D100'),
  },
  {
    type: 'color4',
    startColor: '#D5E8E4',
    endColor: '#5DE9CD',
    color: BABYLON.Color3.FromHexString('#5DE9CD'),
  },
  {
    type: 'color5',
    startColor: '#E2D7E9',
    endColor: '#BD88E2',
    color: BABYLON.Color3.FromHexString('#BD88E2'),
  },
  {
    type: 'color6',
    startColor: '#EDEDED',
    endColor: '#CBCBCB',
    color: BABYLON.Color3.FromHexString('#CBCBCB'),
  },
  {
    type: 'color7',
    startColor: '#FEE9DF',
    endColor: '#FBBA9D',
    color: BABYLON.Color3.FromHexString('#FBBA9D'),
  },
];
